...
class ReachV1ProfilesDomainsSuspendedSenderEmailResource(BaseModel):
    """
    A sender address on the connected domain that is no longer allowed to send.
    """ # noqa: E501
    email: Optional[StrictStr] = None
    email_local_part: Optional[StrictStr] = Field(default=None, description="The part of the address before the @.")
    suspended_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["email", "email_local_part", "suspended_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "email_local_part": obj.get("email_local_part"),
