...
class AgencyHostingV1SetupsCreateSetupRequestDeriveDomain(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of from_vhost
        if self.from_vhost:
            _dict['from_vhost'] = self.from_vhost.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from_vhost": AgencyHostingV1SetupsCreateSetupRequestDeriveDomainFromVhost.from_dict(obj["from_vhost"]) if obj.get("from_vhost") is not None else None
        })
        return _obj
