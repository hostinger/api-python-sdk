...
class AgencyHostingV1SetupsCreateSetupRequestWordpress(BaseModel):
    """
    WordPress installation options
    """ # noqa: E501
    language: StrictStr
    title: StrictStr
    admin: AgencyHostingV1SetupsCreateSetupRequestWordpressAdmin
    __properties: ClassVar[List[str]] = ["language", "title", "admin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "admin": AgencyHostingV1SetupsCreateSetupRequestWordpressAdmin.from_dict(obj["admin"]) if obj.get("admin") is not None else None
        })
        return _obj
