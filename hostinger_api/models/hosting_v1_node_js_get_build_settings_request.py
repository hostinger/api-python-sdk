...
class HostingV1NodeJsGetBuildSettingsRequest(BaseModel):
    """
    HostingV1NodeJsGetBuildSettingsRequest
    """ # noqa: E501
    archive_path: StrictStr = Field(description="The path to the archive file relative to the document root of the vhost")
