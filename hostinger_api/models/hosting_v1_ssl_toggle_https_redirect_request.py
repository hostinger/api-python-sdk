...
class HostingV1SslToggleHttpsRedirectRequest(BaseModel):
    """
    HostingV1SslToggleHttpsRedirectRequest
    """ # noqa: E501
    is_enabled: StrictBool = Field(description="Turn the HTTP to HTTPS redirect on (true) or off (false) for the website.")
