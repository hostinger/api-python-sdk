...
class HostingWordpressApi:
    ...
    def install_word_press_v1(
        self,
        username: StrictStr,
        hosting_v1_wordpress_install_wordpress_request: HostingV1WordpressInstallWordpressRequest,
        ...
        :type username: str
        :param hosting_v1_wordpress_install_wordpress_request: (required)
        :type hosting_v1_wordpress_install_wordpress_request: HostingV1WordpressInstallWordpressRequest
        ...
        _param = self._install_word_press_v1_serialize(
            username=username,
            hosting_v1_wordpress_install_wordpress_request=hosting_v1_wordpress_install_wordpress_request,
    ...
    def _install_word_press_v1_serialize(
        self,
        username,
        hosting_v1_wordpress_install_wordpress_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if hosting_v1_wordpress_install_wordpress_request is not None:
            _body_params = hosting_v1_wordpress_install_wordpress_request
    ...
    def list_word_press_installations_v1(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[HostingV1WordpressWordpressInstallationResource]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[HostingV1WordpressWordpressInstallationResource]",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
        response_data = self.api_client.call_api(
    ...
    def list_word_press_installations_v1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[HostingV1WordpressWordpressInstallationResource]]:
        """List WordPress installations
