...
[**update_domain_forwarding_v1**](DomainsForwardingApi.md#update_domain_forwarding_v1) | **PUT** /api/domains/v1/forwarding/{domain} | Update domain forwarding
...
# **update_domain_forwarding_v1**
> DomainsV1ForwardingForwardingResource update_domain_forwarding_v1(domain, domains_v1_forwarding_update_request)
...
with hostinger_api.ApiClient(configuration) as api_client:
    ...
    api_instance = hostinger_api.DomainsForwardingApi(api_client)
    domain = 'mydomain.tld' # str | Domain name
    domains_v1_forwarding_update_request = hostinger_api.DomainsV1ForwardingUpdateRequest() # DomainsV1ForwardingUpdateRequest | 

    try:
        # Update domain forwarding
        api_response = api_instance.update_domain_forwarding_v1(domain, domains_v1_forwarding_update_request)
        print("The response of DomainsForwardingApi->update_domain_forwarding_v1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainsForwardingApi->update_domain_forwarding_v1: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **domain** | **str**| Domain name | 
 **domains_v1_forwarding_update_request** | [**DomainsV1ForwardingUpdateRequest**](DomainsV1ForwardingUpdateRequest.md)|  | 
