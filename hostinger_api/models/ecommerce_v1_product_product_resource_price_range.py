...
class EcommerceV1ProductProductResourcePriceRange(BaseModel):
    """
    Effective price bounds across the product's variants.
    """ # noqa: E501
    min: Optional[StrictInt] = Field(default=None, description="Lowest effective variant price in the smallest currency unit, or null if unpriced.")
    max: Optional[StrictInt] = Field(default=None, description="Highest effective variant price in the smallest currency unit, or null if unpriced.")
    currency_code: Optional[StrictStr] = Field(default=None, description="The store currency the range is expressed in.")
