...
class MailListWebhooksV1200Response(BaseModel):
    """
    MailListWebhooksV1200Response
    """ # noqa: E501
    data: Optional[List[MailV1WebhooksWebhookResource]] = Field(default=None, description="Array of [`Mail.V1.Webhooks.WebhookResource`](#model/mailv1webhookswebhookresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MailV1WebhooksWebhookResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
