...
class DomainsV1PortfolioAuthCodeAuthCodeResource(BaseModel):
    """
    DomainsV1PortfolioAuthCodeAuthCodeResource
    """ # noqa: E501
    auth_code: Optional[StrictStr] = Field(default=None, description="Domain authorization code used to transfer the domain to another registrar.")
