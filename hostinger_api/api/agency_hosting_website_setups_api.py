...
class AgencyHostingWebsiteSetupsApi:
    ...
    def create_a_new_website_v1(
        ...
        _param = self._create_a_new_website_v1_serialize(
            order_id=order_id,
    ...
    @validate_call
    def create_a_new_website_v1_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="Agency Plan order ID")],
        agency_hosting_v1_setups_create_setup_request: AgencyHostingV1SetupsCreateSetupRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def create_a_new_website_v1_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="Agency Plan order ID")],
        agency_hosting_v1_setups_create_setup_request: AgencyHostingV1SetupsCreateSetupRequest,
        _request_timeout: Union[
    ...
    def _create_a_new_website_v1_serialize(
        self,
        order_id,
    ...
    @validate_call
    def get_website_setup_status_v1(
        self,
        order_id: Annotated[StrictInt, Field(description="Agency Plan order ID")],
        ...
        _param = self._get_website_setup_status_v1_serialize(
            order_id=order_id,
    ...
    @validate_call
    def get_website_setup_status_v1_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="Agency Plan order ID")],
        setup_uuid: Annotated[StrictStr, Field(description="Website setup UUID")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_website_setup_status_v1_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="Agency Plan order ID")],
        setup_uuid: Annotated[StrictStr, Field(description="Website setup UUID")],
        _request_timeout: Union[
    ...
    def _get_website_setup_status_v1_serialize(
        self,
        order_id,
        setup_uuid,
        _request_auth,
