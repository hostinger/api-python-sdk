...
class WordPressV1InstallationsVersionResource(BaseModel):
    """
    WordPressV1InstallationsVersionResource
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, description="Installed WordPress core version")
    vulnerabilities: Optional[List[WordPressV1CommonVulnerabilityResource]] = Field(default=None, description="Known vulnerabilities affecting the installed core version")
    __properties: ClassVar[List[str]] = ["version", "vulnerabilities"]
