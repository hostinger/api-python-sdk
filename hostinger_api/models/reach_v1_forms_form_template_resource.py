...
class ReachV1FormsFormTemplateResource(BaseModel):
    """
    The rendered form template. Both fields stay null until the template has been generated.
    """ # noqa: E501
    uuid: Optional[StrictStr] = None
    path: Optional[StrictStr] = Field(default=None, description="Storage path of the template HTML, relative to the storage directory of this profile. Get the form details to receive a directly usable URL instead.")
    __properties: ClassVar[List[str]] = ["uuid", "path"]
