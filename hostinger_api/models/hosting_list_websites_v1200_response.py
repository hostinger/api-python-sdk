...
class HostingListWebsitesV1200Response(BaseModel):
    """
    HostingListWebsitesV1200Response
    """ # noqa: E501
    data: Optional[List[HostingV1WebsitesWebsiteResource]] = Field(default=None, description="Array of [`Hosting.V1.Websites.WebsiteResource`](#model/hostingv1websiteswebsiteresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HostingV1WebsitesWebsiteResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
