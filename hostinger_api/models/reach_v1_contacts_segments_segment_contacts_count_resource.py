...
class ReachV1ContactsSegmentsSegmentContactsCountResource(BaseModel):
    """
    ReachV1ContactsSegmentsSegmentContactsCountResource
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Contacts currently matching the segment conditions")
