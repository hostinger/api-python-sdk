...
class EcommerceV1VariantVariantListResponseResource(BaseModel):
    """
    EcommerceV1VariantVariantListResponseResource
    """ # noqa: E501
    data: Optional[List[EcommerceV1VariantVariantResource]] = Field(default=None, description="The variants.")
