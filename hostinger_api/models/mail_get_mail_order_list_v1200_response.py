...
class MailGetMailOrderListV1200Response(BaseModel):
    """
    MailGetMailOrderListV1200Response
    """ # noqa: E501
    data: Optional[List[MailV1OrdersOrderResource]] = Field(default=None, description="Array of [`Mail.V1.Orders.OrderResource`](#model/mailv1ordersorderresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MailV1OrdersOrderResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
