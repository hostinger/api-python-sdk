...
class AgencyHostingDatacentersApi:
    ...
    @validate_call
    def list_available_datacenters_v1(
        self,
        ...
        _param = self._list_available_datacenters_v1_serialize(
            order_id=order_id,
    ...
    @validate_call
    def list_available_datacenters_v1_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="Agency Plan order ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_available_datacenters_v1_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="Agency Plan order ID")],
        _request_timeout: Union[
            None,
    ...
    def _list_available_datacenters_v1_serialize(
        self,
        order_id,
        _request_auth,
        _content_type,
