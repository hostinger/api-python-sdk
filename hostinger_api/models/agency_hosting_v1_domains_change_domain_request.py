...
class AgencyHostingV1DomainsChangeDomainRequest(BaseModel):
    """
    AgencyHostingV1DomainsChangeDomainRequest
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(description="New domain to assign to the website. Set to null to revert to the temporary domain.")
