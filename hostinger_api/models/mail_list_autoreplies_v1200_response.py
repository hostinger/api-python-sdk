...
class MailListAutorepliesV1200Response(BaseModel):
    """
    MailListAutorepliesV1200Response
    """ # noqa: E501
    data: Optional[List[MailV1AutorepliesAutoreplyResource]] = Field(default=None, description="Array of [`Mail.V1.Autoreplies.AutoreplyResource`](#model/mailv1autorepliesautoreplyresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MailV1AutorepliesAutoreplyResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
