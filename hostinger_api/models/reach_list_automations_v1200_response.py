...
class ReachListAutomationsV1200Response(BaseModel):
    """
    ReachListAutomationsV1200Response
    """ # noqa: E501
    data: Optional[List[ReachV1AutomationsAutomationResource]] = Field(default=None, description="Array of [`Reach.V1.Automations.AutomationResource`](#model/reachv1automationsautomationresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ReachV1AutomationsAutomationResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
