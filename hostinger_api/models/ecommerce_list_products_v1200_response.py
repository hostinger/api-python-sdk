...
class EcommerceListProductsV1200Response(BaseModel):
    """
    EcommerceListProductsV1200Response
    """ # noqa: E501
    data: Optional[List[EcommerceV1ProductProductResource]] = Field(default=None, description="Array of [`Ecommerce.V1.Product.ProductResource`](#model/ecommercev1productproductresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EcommerceV1ProductProductResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
