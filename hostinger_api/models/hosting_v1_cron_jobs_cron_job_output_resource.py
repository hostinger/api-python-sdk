...
class HostingV1CronJobsCronJobOutputResource(BaseModel):
    """
    HostingV1CronJobsCronJobOutputResource
    """ # noqa: E501
    output: StrictStr = Field(description="Output captured from the last cron job execution. Empty when the cron job has not run yet.")
