...
class AgencyHostingV1WebsitesWebsiteStagingRootResource(BaseModel):
    """
    AgencyHostingV1WebsitesWebsiteStagingRootResource
    """ # noqa: E501
    uid: Optional[StrictStr] = Field(default=None, description="UID of the website this is a staging environment of")
