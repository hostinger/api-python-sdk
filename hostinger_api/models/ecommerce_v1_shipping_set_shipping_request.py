...
class EcommerceV1ShippingSetShippingRequest(BaseModel):
    """
    EcommerceV1ShippingSetShippingRequest
    """ # noqa: E501
    price: Annotated[int, Field(strict=True, ge=0)] = Field(description="Flat shipping rate in the smallest currency unit (e.g. cents). Use 0 for free shipping.")
