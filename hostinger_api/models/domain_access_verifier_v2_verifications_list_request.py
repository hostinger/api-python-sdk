...
class DomainAccessVerifierV2VerificationsListRequest(BaseModel):
    """
    DomainAccessVerifierV2VerificationsListRequest
    """ # noqa: E501
    domains: List[StrictStr] = Field(description="The list of domains for which to get verification details for.")
