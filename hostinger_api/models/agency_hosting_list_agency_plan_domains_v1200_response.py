...
class AgencyHostingListAgencyPlanDomainsV1200Response(BaseModel):
    """
    AgencyHostingListAgencyPlanDomainsV1200Response
    """ # noqa: E501
    data: Optional[List[AgencyHostingV1DomainsDomainResource]] = Field(default=None, description="Array of [`AgencyHosting.V1.Domains.DomainResource`](#model/agencyhostingv1domainsdomainresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AgencyHostingV1DomainsDomainResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
