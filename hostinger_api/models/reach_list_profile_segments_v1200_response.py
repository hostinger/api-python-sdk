...
class ReachListProfileSegmentsV1200Response(BaseModel):
    """
    ReachListProfileSegmentsV1200Response
    """ # noqa: E501
    data: Optional[List[ReachV1ContactsSegmentsSegmentListItemResource]] = Field(default=None, description="Array of [`Reach.V1.Contacts.Segments.SegmentListItemResource`](#model/reachv1contactssegmentssegmentlistitemresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ReachV1ContactsSegmentsSegmentListItemResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
