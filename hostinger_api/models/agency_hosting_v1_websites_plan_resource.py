...
class AgencyHostingV1WebsitesPlanResource(BaseModel):
    """
    Website plan details
    """ # noqa: E501
    name: Optional[StrictStr] = None
    display_name: Optional[StrictStr] = None
    has_cdn: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "display_name", "has_cdn"]
