...
class WordPressV1MemcachedToggleMemcachedRequest(BaseModel):
    """
    WordPressV1MemcachedToggleMemcachedRequest
    """ # noqa: E501
    enabled: StrictBool = Field(description="Activate (true) or deactivate (false) the Memcached object cache for the WordPress installation.")
