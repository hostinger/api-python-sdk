...
class HorizonsV1WebsitesCreateWebsiteRequestMessageInner(BaseModel):
    """
    HorizonsV1WebsitesCreateWebsiteRequestMessageInner
    """ # noqa: E501
    type: StrictStr
    text: Annotated[str, Field(strict=True, max_length=20000)] = Field(description="Detailed project specification. Include purpose, key features, user flows, data models, and design preferences. The specification should be detailed and comprehensive, covering all aspects of the project.")
