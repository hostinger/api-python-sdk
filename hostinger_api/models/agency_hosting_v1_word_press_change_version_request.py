...
class AgencyHostingV1WordPressChangeVersionRequest(BaseModel):
    """
    AgencyHostingV1WordPressChangeVersionRequest
    """ # noqa: E501
    version: StrictStr = Field(description="Target WordPress core version to install. Must be one of the available versions.")
