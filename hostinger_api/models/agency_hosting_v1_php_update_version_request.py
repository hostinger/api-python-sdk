...
class AgencyHostingV1PhpUpdateVersionRequest(BaseModel):
    """
    AgencyHostingV1PhpUpdateVersionRequest
    """ # noqa: E501
    version: StrictStr = Field(description="PHP version to switch the website to, as major.minor. Must be one of the versions returned by the available versions endpoint.")
