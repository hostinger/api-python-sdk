...
class EcommerceV1StoreStoreCreationResourceStore(BaseModel):
    """
    ...
    h_panel_id: Optional[StrictStr] = Field(default=None, description="Identifier of the hPanel account that owns the store.")
    created_at: Optional[datetime] = Field(default=None, description="Creation date")
    default_currency_code: Optional[StrictStr] = Field(default=None, description="Default currency code (ISO 4217), in lowercase.")
    __properties: ClassVar[List[str]] = ["id", "name", "company_name", "h_panel_id", "created_at", "default_currency_code"]
