...
class VPSFirewallApi:
    ...
    def get_firewall_list_v1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VPSV1FirewallListResponse]:
        """Get firewall list
    ...
    @validate_call
    def replace_all_firewall_rules_in_group_v1(
        self,
        firewall_id: Annotated[StrictInt, Field(description="Firewall ID")],
        vpsv1_firewall_rules_replace_request: VPSV1FirewallRulesReplaceRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param firewall_id: Firewall ID (required)
        :type firewall_id: int
        :param vpsv1_firewall_rules_replace_request: (required)
        :type vpsv1_firewall_rules_replace_request: VPSV1FirewallRulesReplaceRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._replace_all_firewall_rules_in_group_v1_serialize(
            firewall_id=firewall_id,
            vpsv1_firewall_rules_replace_request=vpsv1_firewall_rules_replace_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def replace_all_firewall_rules_in_group_v1_with_http_info(
        self,
        firewall_id: Annotated[StrictInt, Field(description="Firewall ID")],
        vpsv1_firewall_rules_replace_request: VPSV1FirewallRulesReplaceRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def replace_all_firewall_rules_in_group_v1_without_preload_content(
        self,
        firewall_id: Annotated[StrictInt, Field(description="Firewall ID")],
        vpsv1_firewall_rules_replace_request: VPSV1FirewallRulesReplaceRequest,
        _request_timeout: Union[
    ...
    def _replace_all_firewall_rules_in_group_v1_serialize(
        self,
        firewall_id,
        vpsv1_firewall_rules_replace_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if vpsv1_firewall_rules_replace_request is not None:
            _body_params = vpsv1_firewall_rules_replace_request
    ...
    @validate_call
    def sync_firewall_to_all_assigned_vms_v1(
        self,
        firewall_id: Annotated[StrictInt, Field(description="Firewall ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._sync_firewall_to_all_assigned_vms_v1_serialize(
            firewall_id=firewall_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def sync_firewall_to_all_assigned_vms_v1_with_http_info(
        self,
        firewall_id: Annotated[StrictInt, Field(description="Firewall ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def sync_firewall_to_all_assigned_vms_v1_without_preload_content(
        self,
        firewall_id: Annotated[StrictInt, Field(description="Firewall ID")],
        _request_timeout: Union[
            None,
    ...
    def _sync_firewall_to_all_assigned_vms_v1_serialize(
        self,
        firewall_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/vps/v1/firewall/{firewallId}/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sync_firewall_v1(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/vps/v1/firewall/{firewallId}/sync/{virtualMachineId} is deprecated.", DeprecationWarning)
