...
class HostingV1CacheToggleCachelessModeRequest(BaseModel):
    """
    HostingV1CacheToggleCachelessModeRequest
    """ # noqa: E501
    enabled: StrictBool = Field(description="Turn development (cacheless) mode on (true) or off (false) for the website.")
