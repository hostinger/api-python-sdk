...
class ReachListProfileContactsV1200Response(BaseModel):
    """
    ReachListProfileContactsV1200Response
    """ # noqa: E501
    data: Optional[List[ReachV1ContactsProfileContactResource]] = Field(default=None, description="Array of [`Reach.V1.Contacts.ProfileContactResource`](#model/reachv1contactsprofilecontactresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ReachV1ContactsProfileContactResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
