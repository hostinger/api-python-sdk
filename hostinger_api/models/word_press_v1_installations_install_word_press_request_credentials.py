...
class WordPressV1InstallationsInstallWordPressRequestCredentials(BaseModel):
    """
    WordPress admin credentials
    """ # noqa: E501
    email: StrictStr
    login: StrictStr = Field(description="WordPress admin username")
    password: SecretStr
    __properties: ClassVar[List[str]] = ["email", "login", "password"]
