...
class EcommerceV1OrderOrderDetailResourceShippingAddress(BaseModel):
    """
    ...
    province_code: Optional[StrictStr] = None
    postal_code: Optional[StrictStr] = None
    country_code: Optional[StrictStr] = None
    phone: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "company", "address_1", "address_2", "city", "province_code", "postal_code", "country_code", "phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "city": obj.get("city"),
            "province_code": obj.get("province_code"),
