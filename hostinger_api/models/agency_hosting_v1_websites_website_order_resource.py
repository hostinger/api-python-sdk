...
class AgencyHostingV1WebsitesWebsiteOrderResource(BaseModel):
    """
    ...
    plan: Optional[AgencyHostingV1WebsitesWebsiteOrderPlanResource] = None
    __properties: ClassVar[List[str]] = ["id", "status", "created_at", "plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plan": AgencyHostingV1WebsitesWebsiteOrderPlanResource.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
