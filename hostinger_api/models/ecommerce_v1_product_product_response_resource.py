...
class EcommerceV1ProductProductResponseResource(BaseModel):
    """
    EcommerceV1ProductProductResponseResource
    """ # noqa: E501
    data: Optional[EcommerceV1ProductProductResource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EcommerceV1ProductProductResource.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
