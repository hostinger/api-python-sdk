...
class EcommerceListDiscountsV1200Response(BaseModel):
    """
    EcommerceListDiscountsV1200Response
    """ # noqa: E501
    data: Optional[List[EcommerceV1DiscountDiscountResource]] = Field(default=None, description="Array of [`Ecommerce.V1.Discount.DiscountResource`](#model/ecommercev1discountdiscountresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EcommerceV1DiscountDiscountResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
