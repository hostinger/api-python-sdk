...
class EcommerceGetStoresV1200Response(BaseModel):
    """
    EcommerceGetStoresV1200Response
    """ # noqa: E501
    data: Optional[List[EcommerceV1StoreStoreResource]] = Field(default=None, description="Array of [`Ecommerce.V1.Store.StoreResource`](#model/ecommercev1storestoreresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EcommerceV1StoreStoreResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
