...
**source_type** | **str** | Where the files come from: &#x60;archive&#x60; (an uploaded archive on the website) or &#x60;git&#x60; (a branch of a repository reachable through a Git installation). | 
