...
class HostingV1WebsitesDeleteWebsiteRequest(BaseModel):
    """
    HostingV1WebsitesDeleteWebsiteRequest
    """ # noqa: E501
    confirm: StrictBool = Field(description="Must be boolean true to confirm the permanent deletion of the website.")
