...
class AgencyHostingV1SetupsCreateSetupRequestSettings(BaseModel):
    """
    Website settings
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "php": AgencyHostingV1SetupsCreateSetupRequestSettingsPhp.from_dict(obj["php"]) if obj.get("php") is not None else None
        })
        return _obj
