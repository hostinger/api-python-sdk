...
class AgencyHostingV1WebsitesWebsiteOrderPlanResource(BaseModel):
    """
    AgencyHostingV1WebsitesWebsiteOrderPlanResource
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Plan name")
    parameters: Optional[AgencyHostingV1WebsitesWebsiteOrderPlanResourceParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "parameters": AgencyHostingV1WebsitesWebsiteOrderPlanResourceParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
