...
class ReachFormsApi:
    ...
    def delete_form_v1(
        ...
        form_uuid: Annotated[StrictStr, Field(description="Form uuid parameter")],
        ...
        :param form_uuid: Form uuid parameter (required)
        :type form_uuid: str
        ...
        _param = self._delete_form_v1_serialize(
    ...
    @validate_call
    def delete_form_v1_with_http_info(
        self,
        profile_uuid: Annotated[StrictStr, Field(description="Profile uuid parameter")],
        form_uuid: Annotated[StrictStr, Field(description="Form uuid parameter")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_form_v1_without_preload_content(
        self,
        profile_uuid: Annotated[StrictStr, Field(description="Profile uuid parameter")],
        form_uuid: Annotated[StrictStr, Field(description="Form uuid parameter")],
        _request_timeout: Union[
    ...
    def _delete_form_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/reach/v1/profiles/{profileUuid}/forms/{formUuid}',
    ...
    def get_form_details_v1(
        ...
        _param = self._get_form_details_v1_serialize(
            profile_uuid=profile_uuid,
            form_uuid=form_uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ReachV1FormsFormDetailsResource",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_form_details_v1_with_http_info(
        self,
        profile_uuid: Annotated[StrictStr, Field(description="Profile uuid parameter")],
        form_uuid: Annotated[StrictStr, Field(description="Form uuid parameter")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReachV1FormsFormDetailsResource]:
        """Get form details
    ...
    @validate_call
    def get_form_details_v1_without_preload_content(
        self,
        profile_uuid: Annotated[StrictStr, Field(description="Profile uuid parameter")],
        form_uuid: Annotated[StrictStr, Field(description="Form uuid parameter")],
        _request_timeout: Union[
    ...
    def _get_form_details_v1_serialize(
        self,
        profile_uuid,
        form_uuid,
        _request_auth,
    ...
    def list_forms_v1(
        ...
        _param = self._list_forms_v1_serialize(
            profile_uuid=profile_uuid,
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ReachListFormsV1200Response",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def list_forms_v1_with_http_info(
        self,
        profile_uuid: Annotated[StrictStr, Field(description="Profile uuid parameter")],
        page: Annotated[Optional[StrictInt], Field(description="Page number")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=100, strict=True)]], Field(description="Number of items per page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReachListFormsV1200Response]:
        """List forms
    ...
    @validate_call
    def list_forms_v1_without_preload_content(
        self,
        profile_uuid: Annotated[StrictStr, Field(description="Profile uuid parameter")],
        page: Annotated[Optional[StrictInt], Field(description="Page number")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=100, strict=True)]], Field(description="Number of items per page")] = None,
    ...
    def _list_forms_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/reach/v1/profiles/{profileUuid}/forms',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
