...
class WordPressV1InstallationsInstallWordPressRequestDatabase(BaseModel):
    """
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Database name (username prefix added if missing)")
