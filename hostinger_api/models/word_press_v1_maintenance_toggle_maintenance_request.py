...
class WordPressV1MaintenanceToggleMaintenanceRequest(BaseModel):
    """
    WordPressV1MaintenanceToggleMaintenanceRequest
    """ # noqa: E501
    enabled: StrictBool = Field(description="Enable (true) or disable (false) maintenance mode for the WordPress installation.")
