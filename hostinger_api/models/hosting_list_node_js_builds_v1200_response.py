...
class HostingListNodeJSBuildsV1200Response(BaseModel):
    """
    HostingListNodeJSBuildsV1200Response
    """ # noqa: E501
    data: Optional[List[HostingV1NodeJsBuildResource]] = Field(default=None, description="Array of [`Hosting.V1.NodeJs.BuildResource`](#model/hostingv1nodejsbuildresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HostingV1NodeJsBuildResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
