...
class MailV1SchemaCreateApiTokenRequestSchema(BaseModel):
    """
    MailV1SchemaCreateApiTokenRequestSchema
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Human-readable label for this token")
    scope: MailV1SchemaCreateApiTokenRequestSchemaScope
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "scope": MailV1SchemaCreateApiTokenRequestSchemaScope.from_dict(obj["scope"]) if obj.get("scope") is not None else None
        })
        return _obj
