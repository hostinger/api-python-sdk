...
class HostingListAccountDatabasesV1200Response(BaseModel):
    """
    HostingListAccountDatabasesV1200Response
    """ # noqa: E501
    data: Optional[List[HostingV1DatabasesDatabaseResource]] = Field(default=None, description="Array of [`Hosting.V1.Databases.DatabaseResource`](#model/hostingv1databasesdatabaseresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HostingV1DatabasesDatabaseResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
