...
class WordPressV1MaintenanceMaintenanceStatusResource(BaseModel):
    """
    WordPressV1MaintenanceMaintenanceStatusResource
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Current maintenance mode status for the WordPress installation")
