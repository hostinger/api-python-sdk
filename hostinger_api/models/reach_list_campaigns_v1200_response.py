...
class ReachListCampaignsV1200Response(BaseModel):
    """
    ReachListCampaignsV1200Response
    """ # noqa: E501
    data: Optional[List[ReachV1CampaignsCampaignResource]] = Field(default=None, description="Array of [`Reach.V1.Campaigns.CampaignResource`](#model/reachv1campaignscampaignresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ReachV1CampaignsCampaignResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
