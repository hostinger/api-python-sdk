...
class AgencyHostingV1WebsitesSslCertResource(BaseModel):
    """
    AgencyHostingV1WebsitesSslCertResource
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="SSL cert names")
    expires_at: Optional[datetime] = None
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["names", "expires_at", "created_at"]
