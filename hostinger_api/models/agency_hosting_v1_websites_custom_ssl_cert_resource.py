...
class AgencyHostingV1WebsitesCustomSslCertResource(BaseModel):
    """
    AgencyHostingV1WebsitesCustomSslCertResource
    """ # noqa: E501
    is_expired: Optional[StrictBool] = Field(default=None, description="Is the SSL certificate expired")
    expires_at: Optional[datetime] = None
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["is_expired", "expires_at", "created_at"]
