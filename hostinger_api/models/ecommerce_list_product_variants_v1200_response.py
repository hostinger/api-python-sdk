...
class EcommerceListProductVariantsV1200Response(BaseModel):
    """
    EcommerceListProductVariantsV1200Response
    """ # noqa: E501
    data: Optional[List[EcommerceV1VariantVariantResource]] = Field(default=None, description="Array of [`Ecommerce.V1.Variant.VariantResource`](#model/ecommercev1variantvariantresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EcommerceV1VariantVariantResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
