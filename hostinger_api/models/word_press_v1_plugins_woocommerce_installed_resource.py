...
class WordPressV1PluginsWoocommerceInstalledResource(BaseModel):
    """
    WordPressV1PluginsWoocommerceInstalledResource
    """ # noqa: E501
    is_installed: Optional[StrictBool] = Field(default=None, description="Whether WooCommerce is installed on any WordPress installation of the domain")
    __properties: ClassVar[List[str]] = ["is_installed"]
