...
------------- | ------------- | -------------
[**create_a_new_website_v1**](AgencyHostingWebsiteSetupsApi.md#create_a_new_website_v1) | **POST** /api/agency-hosting/v1/orders/{order_id}/websites/setups | Create a new website
[**get_website_setup_status_v1**](AgencyHostingWebsiteSetupsApi.md#get_website_setup_status_v1) | **GET** /api/agency-hosting/v1/orders/{order_id}/websites/setups/{setup_uuid} | Get website setup status


# **create_a_new_website_v1**
> AgencyHostingV1SetupsWebsiteSetupResource create_a_new_website_v1(order_id, agency_hosting_v1_setups_create_setup_request)
...
with hostinger_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a new website
        api_response = api_instance.create_a_new_website_v1(order_id, agency_hosting_v1_setups_create_setup_request)
        print("The response of AgencyHostingWebsiteSetupsApi->create_a_new_website_v1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AgencyHostingWebsiteSetupsApi->create_a_new_website_v1: %s\n" % e)
```
...
# **get_website_setup_status_v1**
> AgencyHostingV1SetupsWebsiteSetupStatusResource get_website_setup_status_v1(order_id, setup_uuid)
...
with hostinger_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get website setup status
        api_response = api_instance.get_website_setup_status_v1(order_id, setup_uuid)
        print("The response of AgencyHostingWebsiteSetupsApi->get_website_setup_status_v1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AgencyHostingWebsiteSetupsApi->get_website_setup_status_v1: %s\n" % e)
```
