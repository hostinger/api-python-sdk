...
class WordPressV1ThemesActivateThemeRequest(BaseModel):
    """
    WordPressV1ThemesActivateThemeRequest
    """ # noqa: E501
    theme: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="Slug of the installed theme to activate.")
