...
class HostingDatacentersApi:
    ...
    def list_available_datacenters_v1(
    ...
    ) -> List[HostingV1DatacenterDatacenterResource]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[HostingV1DatacenterDatacenterResource]",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
    ...
    def list_available_datacenters_v1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[HostingV1DatacenterDatacenterResource]]:
        """List available datacenters
    ...
    def _list_available_datacenters_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/hosting/v1/datacenters',
