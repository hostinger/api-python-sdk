...
class EcommerceListStoreOrdersV1200Response(BaseModel):
    """
    EcommerceListStoreOrdersV1200Response
    """ # noqa: E501
    data: Optional[List[EcommerceV1OrderOrderResource]] = Field(default=None, description="Array of [`Ecommerce.V1.Order.OrderResource`](#model/ecommercev1orderorderresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EcommerceV1OrderOrderResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
