...
class WordPressV1LoginLoginLinksResource(BaseModel):
    """
    WordPressV1LoginLoginLinksResource
    """ # noqa: E501
    login: Optional[StrictStr] = Field(default=None, description="Primary auto-login URL for the WordPress installation")
    fallback: Optional[StrictStr] = Field(default=None, description="Fallback auto-login URL using the temporary Hostinger domain")
    default: Optional[StrictStr] = Field(default=None, description="Default WordPress admin URL used when auto-login is unavailable")
    __properties: ClassVar[List[str]] = ["login", "fallback", "default"]
