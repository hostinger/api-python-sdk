...
class DomainsV1DomainDomainResource(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Domain name, `null` when not claimed free domain")
    type: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    created_at: Optional[datetime] = None
    expires_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "status", "created_at", "expires_at"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'pending_setup', 'expired']):
            raise ValueError("must be one of enum values ('active', 'pending_setup', 'expired')")
        return value
