...
class HostingV1DatabasesRemoteConnectionsCreateRemoteConnectionRequest(BaseModel):
    """
    HostingV1DatabasesRemoteConnectionsCreateRemoteConnectionRequest
    """ # noqa: E501
    ip: StrictStr = Field(description="Remote host to allow: an IPv4/IPv6 address, or \"%\" for any host.")
