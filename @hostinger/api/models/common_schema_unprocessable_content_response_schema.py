...
class CommonSchemaUnprocessableContentResponseSchema(BaseModel):
    """
    ...
    errors: Optional[CommonSchemaUnprocessableContentResponseSchemaErrors] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": CommonSchemaUnprocessableContentResponseSchemaErrors.from_dict(obj["errors"]) if obj.get("errors") is not None else None,
