...
class ReachListFormsV1200Response(BaseModel):
    """
    ReachListFormsV1200Response
    """ # noqa: E501
    data: Optional[List[ReachV1FormsFormResource]] = Field(default=None, description="Array of [`Reach.V1.Forms.FormResource`](#model/reachv1formsformresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ReachV1FormsFormResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
