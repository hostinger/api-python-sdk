...
class DomainAccessVerifierV2VerificationsActiveVerificationsCollection(BaseModel):
    """
    ...
    """ # noqa: E501
    data: Optional[DomainAccessVerifierV2VerificationsActiveVerificationsCollectionData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DomainAccessVerifierV2VerificationsActiveVerificationsCollectionData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
