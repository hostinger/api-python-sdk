...
class HostingListOrdersV1200Response(BaseModel):
    """
    HostingListOrdersV1200Response
    """ # noqa: E501
    data: Optional[List[HostingV1OrdersOrderResource]] = Field(default=None, description="Array of [`Hosting.V1.Orders.OrderResource`](#model/hostingv1ordersorderresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HostingV1OrdersOrderResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
