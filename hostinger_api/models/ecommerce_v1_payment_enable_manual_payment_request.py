...
class EcommerceV1PaymentEnableManualPaymentRequest(BaseModel):
    """
    EcommerceV1PaymentEnableManualPaymentRequest
    """ # noqa: E501
    title: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Optional display name shown to customers at checkout.")
