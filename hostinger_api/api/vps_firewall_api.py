...
class VPSFirewallApi:
    ...
    def replace_all_firewall_rules_in_group_v1(
        ...
        sync: Annotated[Optional[StrictBool], Field(description="Synchronize the firewall group to all its virtual machines after replacing the rules")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sync: Synchronize the firewall group to all its virtual machines after replacing the rules
        :type sync: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
