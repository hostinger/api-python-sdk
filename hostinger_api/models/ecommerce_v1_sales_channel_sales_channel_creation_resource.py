...
class EcommerceV1SalesChannelSalesChannelCreationResource(BaseModel):
    """
    EcommerceV1SalesChannelSalesChannelCreationResource
    """ # noqa: E501
    sales_channel: Optional[EcommerceV1SalesChannelSalesChannelCreationResourceSalesChannel] = None
    __properties: ClassVar[List[str]] = ["sales_channel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sales_channel": EcommerceV1SalesChannelSalesChannelCreationResourceSalesChannel.from_dict(obj["sales_channel"]) if obj.get("sales_channel") is not None else None
        })
        return _obj
