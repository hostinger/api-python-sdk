...
class AgencyHostingFilesApi:
    ...
    def generate_upload_urlv1(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AgencyHostingV1FilesUploadUrlResource",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
    ...
    def generate_upload_urlv1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgencyHostingV1FilesUploadUrlResource]:
        """Generate upload URL
    ...
    def _generate_upload_urlv1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/agency-hosting/v1/websites/{website_uid}/files/upload-urls',
    ...
    @validate_call
    def import_website_from_archive_v1(
        self,
        website_uid: Annotated[StrictStr, Field(description="Agency Plan website UID")],
        agency_hosting_v1_files_import_archive_request: AgencyHostingV1FilesImportArchiveRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param website_uid: Agency Plan website UID (required)
        :type website_uid: str
        :param agency_hosting_v1_files_import_archive_request: (required)
        :type agency_hosting_v1_files_import_archive_request: AgencyHostingV1FilesImportArchiveRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._import_website_from_archive_v1_serialize(
            website_uid=website_uid,
            agency_hosting_v1_files_import_archive_request=agency_hosting_v1_files_import_archive_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def import_website_from_archive_v1_with_http_info(
        self,
        website_uid: Annotated[StrictStr, Field(description="Agency Plan website UID")],
        agency_hosting_v1_files_import_archive_request: AgencyHostingV1FilesImportArchiveRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def import_website_from_archive_v1_without_preload_content(
        self,
        website_uid: Annotated[StrictStr, Field(description="Agency Plan website UID")],
        agency_hosting_v1_files_import_archive_request: AgencyHostingV1FilesImportArchiveRequest,
        _request_timeout: Union[
    ...
    def _import_website_from_archive_v1_serialize(
        self,
        website_uid,
        agency_hosting_v1_files_import_archive_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if agency_hosting_v1_files_import_archive_request is not None:
            _body_params = agency_hosting_v1_files_import_archive_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/agency-hosting/v1/websites/{website_uid}/files/import-archive',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
