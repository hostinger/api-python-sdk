...
from hostinger-api.api_client import ApiClient, RequestSerialized
from hostinger-api.api_response import ApiResponse
from hostinger-api.rest import RESTResponseType
...
class VPSVirtualMachineApi:
    ...
    def get_metrics_v1(
        self,
        virtual_machine_id: Annotated[StrictInt, Field(description="Virtual Machine ID")],
        date_from: Annotated[StrictStr, Field(description="the date-time notation as defined by RFC 3339, section 5.6")],
        date_to: Annotated[StrictStr, Field(description="the date-time notation as defined by RFC 3339, section 5.6")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param virtual_machine_id: Virtual Machine ID (required)
        :type virtual_machine_id: int
        :param date_from: the date-time notation as defined by RFC 3339, section 5.6 (required)
        :type date_from: str
        :param date_to: the date-time notation as defined by RFC 3339, section 5.6 (required)
        :type date_to: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
