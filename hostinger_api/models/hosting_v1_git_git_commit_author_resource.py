...
class HostingV1GitGitCommitAuthorResource(BaseModel):
    """
    HostingV1GitGitCommitAuthorResource
    """ # noqa: E501
    name: StrictStr = Field(description="Author name as recorded in the commit")
    avatar_url: Optional[StrictStr] = Field(description="Avatar URL of the author on the Git provider")
    __properties: ClassVar[List[str]] = ["name", "avatar_url"]
