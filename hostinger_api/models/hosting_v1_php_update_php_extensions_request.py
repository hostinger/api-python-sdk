...
class HostingV1PhpUpdatePhpExtensionsRequest(BaseModel):
    """
    HostingV1PhpUpdatePhpExtensionsRequest
    """ # noqa: E501
    enable: Optional[List[StrictStr]] = Field(default=None, description="PHP extensions to enable.")
    disable: Optional[List[StrictStr]] = Field(default=None, description="PHP extensions to disable.")
