...
class MailV1LogsCommonDeliveryLogRelayEventResource(BaseModel):
    """
    MailV1LogsCommonDeliveryLogRelayEventResource
    """ # noqa: E501
    address_to: Optional[StrictStr] = None
    relay: Optional[StrictStr] = None
    delay: Optional[StrictStr] = None
    dsn: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    response: Optional[StrictStr] = None
    time: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["address_to", "relay", "delay", "dsn", "status", "response", "time"]
