...
class HostingListWebsiteRedirectsV1200Response(BaseModel):
    """
    HostingListWebsiteRedirectsV1200Response
    """ # noqa: E501
    data: Optional[List[HostingV1RedirectsRedirectResource]] = Field(default=None, description="Array of [`Hosting.V1.Redirects.RedirectResource`](#model/hostingv1redirectsredirectresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HostingV1RedirectsRedirectResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
