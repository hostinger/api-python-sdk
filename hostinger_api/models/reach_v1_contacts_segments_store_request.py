...
class ReachV1ContactsSegmentsStoreRequest(BaseModel):
    """
    ReachV1ContactsSegmentsStoreRequest
    """ # noqa: E501
    name: StrictStr
    conditions: Annotated[List[ReachV1ContactsSegmentsStoreRequestConditionsInner], Field(min_length=1, max_length=5)]
    logic: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "conditions": [ReachV1ContactsSegmentsStoreRequestConditionsInner.from_dict(_item) for _item in obj["conditions"]] if obj.get("conditions") is not None else None,
            "logic": obj.get("logic")
        })
        return _obj
