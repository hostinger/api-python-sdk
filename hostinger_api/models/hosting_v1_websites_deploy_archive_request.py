...
class HostingV1WebsitesDeployArchiveRequest(BaseModel):
    """
    HostingV1WebsitesDeployArchiveRequest
    """ # noqa: E501
    archive_path: StrictStr = Field(description="Relative path to the archive file from website root directory")
