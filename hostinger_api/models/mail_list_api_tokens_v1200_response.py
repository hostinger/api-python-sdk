...
class MailListAPITokensV1200Response(BaseModel):
    """
    MailListAPITokensV1200Response
    """ # noqa: E501
    data: Optional[List[MailV1ApiTokensApiTokenResource]] = Field(default=None, description="Array of [`Mail.V1.ApiTokens.ApiTokenResource`](#model/mailv1apitokensapitokenresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MailV1ApiTokensApiTokenResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
