...
class MailListAccessLogsV1200Response(BaseModel):
    """
    MailListAccessLogsV1200Response
    """ # noqa: E501
    data: Optional[List[MailV1LogsAccessAccessLogResource]] = Field(default=None, description="Array of [`Mail.V1.Logs.Access.AccessLogResource`](#model/mailv1logsaccessaccesslogresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MailV1LogsAccessAccessLogResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
