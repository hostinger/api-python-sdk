...
class ReachV1ContactsSegmentsProfileFilterContactsRequestConditionsInner(BaseModel):
    """
    ReachV1ContactsSegmentsProfileFilterContactsRequestConditionsInner
    """ # noqa: E501
    attribute: StrictStr = Field(description="A built-in contact attribute, or `cf:{fieldUuid}` to target a custom contact field. Which operators are accepted depends on the attribute, so read the segment filter attributes endpoint for the authoritative list.")
    operator: StrictStr
