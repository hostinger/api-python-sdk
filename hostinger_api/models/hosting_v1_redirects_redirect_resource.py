...
class HostingV1RedirectsRedirectResource(BaseModel):
    """
    HostingV1RedirectsRedirectResource
    """ # noqa: E501
    var_from: Optional[StrictStr] = Field(default=None, description="Source URL", alias="from")
    to: Optional[StrictStr] = Field(default=None, description="Destination URL")
