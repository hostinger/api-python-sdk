...
class MailListMailboxActionLogsV1200Response(BaseModel):
    """
    MailListMailboxActionLogsV1200Response
    """ # noqa: E501
    data: Optional[List[MailV1LogsMailboxActionsMailboxActionLogResource]] = Field(default=None, description="Array of [`Mail.V1.Logs.MailboxActions.MailboxActionLogResource`](#model/mailv1logsmailboxactionsmailboxactionlogresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MailV1LogsMailboxActionsMailboxActionLogResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
