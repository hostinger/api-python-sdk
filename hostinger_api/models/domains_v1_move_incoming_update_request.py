...
class DomainsV1MoveIncomingUpdateRequest(BaseModel):
    """
    DomainsV1MoveIncomingUpdateRequest
    """ # noqa: E501
    domain_contacts: DomainsV1MoveIncomingUpdateRequestDomainContacts
    __properties: ClassVar[List[str]] = ["domain_contacts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domain_contacts": DomainsV1MoveIncomingUpdateRequestDomainContacts.from_dict(obj["domain_contacts"]) if obj.get("domain_contacts") is not None else None
        })
        return _obj
