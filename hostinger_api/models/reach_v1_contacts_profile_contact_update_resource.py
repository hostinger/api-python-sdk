...
class ReachV1ContactsProfileContactUpdateResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "surname", "email", "phone", "subscription_status", "subscribed_at", "unsubscribed_at"]
