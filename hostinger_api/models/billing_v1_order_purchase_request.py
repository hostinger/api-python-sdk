...
class BillingV1OrderPurchaseRequest(BaseModel):
    """
    ...
    items: List[BillingV1OrderPurchaseRequestItemsInner] = Field(description="Catalog price items to purchase")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BillingV1OrderPurchaseRequestItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
