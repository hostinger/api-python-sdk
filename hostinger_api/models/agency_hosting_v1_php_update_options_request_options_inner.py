...
class AgencyHostingV1PhpUpdateOptionsRequestOptionsInner(BaseModel):
    """
    AgencyHostingV1PhpUpdateOptionsRequestOptionsInner
    """ # noqa: E501
    name: StrictStr = Field(description="php.ini directive name.")
    value: StrictStr = Field(description="Value to apply.")
