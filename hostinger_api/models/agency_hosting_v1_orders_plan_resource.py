...
class AgencyHostingV1OrdersPlanResource(BaseModel):
    """
    AgencyHostingV1OrdersPlanResource
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Plan display name")
    key: Optional[StrictStr] = Field(default=None, description="Plan key")
