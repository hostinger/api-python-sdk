...
class DomainsV1TransferTransferResource(BaseModel):
    """
    ...
    initiated_at: Optional[datetime] = Field(default=None, description="When the transfer was initiated")
    completed_at: Optional[datetime] = Field(default=None, description="When the transfer completed")
    __properties: ClassVar[List[str]] = ["domain", "status", "initiated_at", "completed_at"]
