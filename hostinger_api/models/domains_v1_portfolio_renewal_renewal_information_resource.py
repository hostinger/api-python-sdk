...
class DomainsV1PortfolioRenewalRenewalInformationResource(BaseModel):
    """
    ...
    expires_at: Optional[datetime] = Field(default=None, description="Domain expiration date")
    __properties: ClassVar[List[str]] = ["domain", "status", "expires_at"]
