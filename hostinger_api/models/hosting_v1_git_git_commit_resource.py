...
class HostingV1GitGitCommitResource(BaseModel):
    """
    HostingV1GitGitCommitResource
    """ # noqa: E501
    hash: StrictStr = Field(description="Full commit SHA")
    message: StrictStr = Field(description="Commit message")
    author: HostingV1GitGitCommitAuthorResource
    __properties: ClassVar[List[str]] = ["hash", "message", "author"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author": HostingV1GitGitCommitAuthorResource.from_dict(obj["author"]) if obj.get("author") is not None else None
        })
        return _obj
