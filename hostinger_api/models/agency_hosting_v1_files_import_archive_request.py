...
class AgencyHostingV1FilesImportArchiveRequest(BaseModel):
    """
    Import a website from an already-uploaded archive
    """ # noqa: E501
    archive_name: StrictStr = Field(description="Archive filename (e.g., archive.zip). The file must already be uploaded to the website's .h5g/ directory.")
    __properties: ClassVar[List[str]] = ["archive_name"]
