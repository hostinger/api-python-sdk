...
class AgencyHostingOrdersApi:
    ...
    @validate_call
    def list_agency_plan_orders_v1(
        self,
        ...
        _param = self._list_agency_plan_orders_v1_serialize(
            page=page,
            per_page=per_page,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AgencyHostingListAgencyPlanOrdersV1200Response",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
    ...
    @validate_call
    def list_agency_plan_orders_v1_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="Page number")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=100, strict=True)]], Field(description="Number of items per page")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgencyHostingListAgencyPlanOrdersV1200Response]:
        """List Agency Plan orders
    ...
    @validate_call
    def list_agency_plan_orders_v1_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="Page number")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=100, strict=True)]], Field(description="Number of items per page")] = None,
        _request_timeout: Union[
    ...
    def _list_agency_plan_orders_v1_serialize(
        self,
        page,
        per_page,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/agency-hosting/v1/orders',
